...
export default function Footer4Col({ imgPath, logoTitle } : { imgPath: string, logoTitle: string }) {
  return (
    <footer className="mt-16 w-full place-self-end border-t border-slate-200 dark:border-slate-800">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex justify-center gap-2 text-primary sm:justify-start">
              ...
              />
              <span className="bg-primary from-foreground via-teal-200 to-primary bg-clip-text text-2xl font-semibold text-transparent dark:bg-gradient-to-b">
                {logoTitle}
              </span>
            </div>
