      ...
      <div className="container relative z-10 mx-auto max-w-6xl px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="mb-8 inline-flex items-center gap-2 rounded-full border border-teal-100 bg-card/50 px-4 py-1.5 shadow-sm backdrop-blur-sm md:mb-12"
          >
            <img src="/coach.svg" alt="logo" className="h-6 w-6" />
          ...
          >
            <h1 className="mx-4 mb-6 text-4xl font-bold tracking-tight sm:text-6xl md:mb-8 md:text-8xl">
              ...
              <span
                className={cn(
                  "bg-gradient-to-r from-primary via-primary/90 to-teal-500 bg-clip-text p-4 text-transparent",
                  pacifico.className,
                  "font-bold",
                )}
              >
          ...
          >
            <Button
              size='lg'
              className="btn rounded-full border-none bg-teal-500 text-white shadow-md shadow-primary/10 cursor-pointer hover:bg-teal-600/90"
